  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="scenicInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="描述" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible"
                       prop="describe"/>
      <el-table-column label="点赞量" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible"
                       prop="likesNumber"/>
      <el-table-column label="评论数" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible"
                       prop="commentsNumber"/>
      <el-table-column label="浏览量" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible"
                       prop="looksNumber"/>
      <el-table-column label="排序" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible"
                       prop="sortNum"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="排序" prop="sortNum">
          <el-input-number :min="0" :max="10" v-model="form.sortNum" placeholder="请输入排序"/>
        </el-form-item>
...
<script>
import {addScenicInfo, delScenicInfo, getScenicInfo, listScenicInfo, updateScenicInfo} from "@/api/manage/scenicInfo";
